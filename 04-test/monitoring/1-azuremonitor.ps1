...
$ResourceGroupName="AzSHCI-Cluster-rg"

# $connaks = Get-AzConnectedKubernetes -ResourceGroupName $ResourceGroupName -Name 4aed5ba2-e641-4c61-9a9b-a3d75ccce070
...
# New-AzConnectedKubernetes -ClusterName $ClusterName -ResourceGroupName $ResourceGroupName -Location eastus
...
Get-AzConnectedKubernetes -ResourceGroupName $ResourceGroupName
