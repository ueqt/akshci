...
1..2 | ForEach-Object {$VMNames="AzSHCI" ; $LABConfig.VMs += @{ VMName = "$VMNames$_" ; Configuration = 'S2D' ; ParentVHD = 'AzSHCI20H2_G2.vhdx' ; HDDNumber = 4 ; HDDSize= 4TB ; MemoryStartupBytes= 64GB; VMProcessorCount=4 ; NestedVirt=$true}}
...
$LabConfig.VMs += @{ VMName = 'Manager' ; ParentVHD = 'Win2019_G2.vhdx' ; MemoryStartupBytes= 12GB; VMProcessorCount=4 ; MGMTNICs=1 }